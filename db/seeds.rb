...
review_2 = Review.create(rating: "⭐️⭐️⭐️⭐️⭐️", title: 'Awesome Brewery', body: "You can bring your dog", brewery: brewery_2, user: User.first)
review_3 = Review.create(rating: "⭐️⭐️⭐️⭐️⭐️", title: 'Had a great time here', body: "Indoor cornhole is fun", brewery: brewery_3, user: User.first)

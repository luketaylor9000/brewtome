...
review_1 = Review.create(rating: "⭐️⭐️⭐️⭐️⭐️", title: 'Great brewery', body: "I'm this brewery's number one fan!", brewery: brewery_1, user: User.first)
review_2 = Review.create(rating: "⭐️⭐️⭐️⭐️⭐️", title: 'Awesome Brewery', body: "You can bring your dog", brewery: brewery_2, user: User.second)
review_3 = Review.create(rating: "⭐️⭐️⭐️⭐️⭐️", title: 'Had a great time here', body: "Indoor cornhole is fun", brewery: brewery_3, user: User.third)
